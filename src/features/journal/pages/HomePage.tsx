            ...
            filtered.map((entry) => (
              ...
              >
                <div className="mb-2 flex items-start justify-between gap-3">
                  <h3 className="font-cute-display text-base text-gray-800 dark:text-slate-100">{entry.title}</h3>
                ...
                <p className="line-clamp-2 text-sm text-gray-600 dark:text-slate-300">{entry.content}</p>
